...
import '../../domain/usecase/create_bot_usecase.dart';
import '../../domain/usecase/delete_bot_usecase.dart';
import '../../domain/usecase/get_bot_list_usecase.dart';
import '../../domain/usecase/update_bot_usecase.dart';
...
class BotListNotifier extends ChangeNotifier{
  ...
  Future<RequestResponse> createBot(bot) async{
    isLoading = true;
    notifyListeners();
