...
class PromptCreateDialog extends StatefulWidget {
  ...
  @override
  State<PromptCreateDialog> createState() => _PromptCreateDialogState();
}

class _PromptCreateDialogState extends State<PromptCreateDialog> {
  late bool _isPublic;
              ...
              child: SingleChildScrollView(
                child: Column(
                  children: [
                    ...
                    VSpacing.sm,
                    _isPublic ? PublicForm(formKey: getIt<FormModel>().publicFormKey, onTitleChanged: (String value) {
                      setState(() {
                      ...
                      formKey: getIt<FormModel>().privateFormKey,
